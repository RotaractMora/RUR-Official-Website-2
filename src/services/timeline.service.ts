import { getFirestore, collection, getDocs, limit, query, DocumentData, QueryDocumentSnapshot, Query, startAfter, orderBy, addDoc, DocumentReference, deleteDoc, doc, updateDoc } from "firebase/firestore";
...
export const updateTimeLineEvent = async (timelineEventId:string, updatedTimelineEvent:ITimelineData):Promise<void> => {
    try {
        const db = getFirestore(app);
