    ...
    <div className="py-10 lg:py-20 mx-auto w-fit md:w-full">
      {lines.map((line, index) => (
        <div
          ...
          className="flex flex-wrap md:flex-row flex-col justify-center align-center max-w-12xl mx-auto"
        >
          {line.map((person, index) => (
            <div
              key={person + "-" + index}
              className="relative w-full sm2:w-[28rem] bg-gradient-to-b dark:from-neutral-900 from-neutral-100 dark:to-neutral-950 to-white p-6 rounded-3xl overflow-hidden shadow-xl dark:border-custom-dark-color-900 border-custom-color-900 border-2 border-solid my-3 sm1:mx-2 mx-0"
            >
              <Grid size={20} />
