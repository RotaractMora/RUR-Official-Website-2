  ...
  if (error) {
    ...
    return (
      <>
        ...
        <div
          id="company-data-list"
          className="p-12 md:w-max mx-auto max-h-screen overflow-y-auto [&::-webkit-scrollbar]:[width:3px] [&::-webkit-scrollbar-thumb]:bg-custom-color-600/20"
        >
          <AnimatePresence>
                ...
                >
                  ...
                  <div>
                    <div className="flex justify-between items-start p-4  bg-custom-color-600/10">
                      ...
                      >
                        <HoverBorderGradient>View</HoverBorderGradient>
                      </motion.button>
                    </div>
          ...
          <ul className="max-w-2xl mx-auto w-full gap-4">
            {cards.map((card, index) => (
              ...
              >
                ...
                <motion.button layoutId={`button-${card.companyId}-${id}`} className="pt-4">
                  <HoverBorderGradient>View</HoverBorderGradient>
                </motion.button>
              </motion.div>
            ))}
