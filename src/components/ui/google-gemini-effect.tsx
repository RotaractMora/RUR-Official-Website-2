      ...
      <div className="space-y-6">
        ...
        >
          <div className="flex flex-col items-center gap-5 text-center">
            <div className="flex items-center gap-2">
              <span
                className={`text-lg font-medium ${signUp ? 'text-blue-400' : 'text-amber-400'}`}
              >
                {signUp ? 'Registration is now open' : 'Registration coming soon'}
              </span>
            </div>
            <button
        ...
        >
          <div className="flex flex-col items-center gap-5 text-center">
            <div className="flex items-center gap-2">
              <span
                className={`text-lg font-medium ${signIn ? 'text-blue-400' : 'text-amber-500'}`}
              >
                {signIn ? 'Sign in is available' : 'Sign In coming soon'}
              </span>
            </div>
            <button
