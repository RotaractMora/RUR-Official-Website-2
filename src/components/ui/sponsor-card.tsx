                ...
                : level === "Silver"
                    ...
                    : level === "Partner"
                        ...
                        : level === "Associate Partner"
                            ? "200 80% 40%" // Ocean Blue for Associate Partner
                            : "30 60% 50%"; // Bronze
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <div className="absolute inset-0 pb-[40%] p-8 flex items-center justify-center">
                        {imgURL ? (
                            <img
                                src={imgURL}
                                alt={name}
                                className="w-full h-full object-contain transition-transform duration-500 ease-in-out group-hover:scale-110 will-change-transform"
                    ...
                    <div
                        className="absolute bottom-0 left-0 right-0 h-[45%] z-20 flex flex-col justify-end p-6 text-white transition-transform duration-300 transform translate-y-0 group-hover:-translate-y-1 backface-hidden will-change-transform"
                    >
                        <h3 className="text-xl font-bold tracking-tight line-clamp-2 leading-tight [transform:translateZ(0)]">{name}</h3>
