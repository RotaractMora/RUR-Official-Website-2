...
export default function ManageTimeline() {
  ...
  const [eventToDelete, setEventToDelete] = useState<ITimelineData | null>(
    null
  );
  const [eventToUpdate, setEventToUpdate] = useState<ITimelineData | null>(
    null
  );
  ...
  const handleError = async (error: any) => {
    ...
    switch (true) {
      ...
      case error.code === "FAILED_PRECONDITION":
        errorMessage =
          "The operation failed due to a server configuration issue.";
  ...
  return (
    <AdminDashboardLayout>
      <div className="dashboard-content p-6 w-4/5 mx-auto rounded-lg">
        ...
        <p className="my-4 text-lg dark:text-gray-300">
          Manage timeline events here
        </p>
